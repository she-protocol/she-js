 ...
 * @example
 * ```tsx
 * import { generateWallet, restoreWallet } from "@she-js/cosmjs";
 *
...
export const restoreWallet = async (seedPhrase: string, hdPath?: HdPath): Promise<DirectSecp256k1HdWallet> => {
	return await DirectSecp256k1HdWallet.fromMnemonic(seedPhrase, { prefix: 'she', hdPaths: [hdPath || getHdPath(0)] });
};
