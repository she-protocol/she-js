# Vite-Wagmi She App Template

This repo provides a basic framework for an application that interacts with She via EVM endpoints.
...
This repository uses helper methods from [@she-js/evm/viem](https://github.com/she-protocol/she-js/tree/main/packages/evm/src/viem)

### Web3 Provider
This component is a She specific wrapper around a Wagmi Provider that should wrap the application. Wrapping the application in this provider will enable it to access hooks in Wagmi. These hooks are enable connection to a wallet and interaction with the chain.
