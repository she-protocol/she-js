import { BANK_PRECOMPILE_ABI, BANK_PRECOMPILE_ADDRESS, WASM_PRECOMPILE_ABI, WASM_PRECOMPILE_ADDRESS } from '@she-js/evm';
...
function Examples() {
	...
	// Example of using precompiles to query native She modules.
	...
	const renderBankSupplyExample = () => {
		return (
			<div className="card">
				<div className="card-header">
					<p className="card__title">Total She supply</p>
					<small className="card__description">
						<a href="https://www.docs.she.io/dev-interoperability/precompiles/bank" target="_blank">
							{' '}
							Bank precompile
						</a>{' '}
						example for querying native She modules
					</small>
				</div>
				<div className="card-body">
					<div className="content-background space-between">
		...
		return (
			<div className="card">
				<div className="card-header">
					...
					<small>
						<a href="https://www.docs.she.io/dev-interoperability/precompiles/cosmwasm" target="_blank">
							WASM Precompile
						</a>{' '}
