...
const helpItems: HelpItem[] = [
	{
		title: 'She Docs',
		description: 'Find in-depth information about She.',
		link: 'https://docs.she.io/'
	},
	{
		title: 'CosmosKit',
	...
	{
		title: 'she-js',
		description: 'Interact with She using @she-js/cosmjs.',
		link: 'https://she-protocol.github.io/she-js/modules/cosmjs.html'
	}
];
...
export function Homepage() {
	return (
		<div className="container">
			<img src="she-logotype.svg" className="logo" alt="SHE logotype" />
