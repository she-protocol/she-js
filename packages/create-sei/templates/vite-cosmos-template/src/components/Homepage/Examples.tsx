import { getCosmWasmClient, getQueryClient, getSigningCosmWasmClient, getStargateClient } from '@she-js/cosmjs';
...
function Examples({ chainId }: ExampleProps) {
	...
	// Example of using the query client to query She modules
			...
			<div className="card">
				<div className="card-header">
					...
					<small className="card__description">
						<a href="https://she-protocol.github.io/she-js/functions/cosmjs.getQueryClient.html" target="_blank">
							She QueryClient
						</a>{' '}
						query example
					</small>
				...
				<div className="card-body">
					<div className="content-background space-between">
						...
						<p>{pool ? pool.bonded_tokens : '---'} SHE</p>
					</div>
					<div className="content-background space-between">
						<small>Unbonded Tokens</small>
						<p>{pool ? pool.not_bonded_tokens : '---'} SHE</p>
					</div>
				</div>
