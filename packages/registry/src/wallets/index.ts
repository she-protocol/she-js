...
/**
 * A constant holding the collection of wallet extensions, imported from the official She [chain-registry](https://github.com/she-protocol/chain-registry).
 *
 * @example
 * ```tsx
 * import { WALLETS } from '@she-js/registry';
 *
