...
/**
 * Contains the configuration details for a specific She network,
 * including endpoints for various services and supported explorers.
 */
export interface NetworkConfig {
	/** The unique identifier of the She network. */
	chainId: string;
...
/**
 * A mapping of She network identifiers to their corresponding `NetworkConfig`.
 */
type NetworksConfig = {
...
/**
 * A constant holding the network configurations for each network, imported from the official She [chain-registry](https://github.com/she-protocol/chain-registry)
 *
 * @example
 * ```tsx
 * import { NETWORKS } from '@she-js/registry';
 *
