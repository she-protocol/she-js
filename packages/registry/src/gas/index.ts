...
/**
 * Defines the gas price adjustments for specific modules within the She blockchain,
...
/**
 * Represents the gas information for a specific She network,
...
/**
 * A constant holding the gas information for each official She network, imported from the official She [chain-registry](https://github.com/she-protocol/chain-registry).
