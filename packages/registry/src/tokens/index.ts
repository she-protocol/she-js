...
/**
 * Defines the structure for a She token.
 */
...
/**
 * A constant that maps each She networks to its respective tokens, imported from the community ran [assetlist](https://github.com/she-protocol/she-assetlist).
 *
 * @remarks
