import { MsgApplyPendingBalance, MsgTransfer, MsgWithdraw } from "@she-js/cosmos/dist/types/encoding/confidentialtransfers"
import { Encoder } from "@she-js/cosmos/encoding"
import { CONFIDENTIAL_TRANSFERS_PRECOMPILE_ABI, CONFIDENTIAL_TRANSFERS_PRECOMPILE_ADDRESS } from "@she-js/evm"
 ...
 * @param denom - The denom of the confidential account.
 * @param amount - Amount to deposit in base units (e.g., 1 SHE = 1_000_000).
 * @returns A Viem-compatible calldata params object.
 */
 ...
 * @param denom - The denom of the confidential account.
 * @param amount - The amount to withdraw in base units (e.g., 1 SHE = 1_000_000).
 * @param client - A Viem PublicClient instance.
 * @param signedDenom - The signed hash of the denom.
 * @returns A Viem-compatible calldata params object or null if the account is uninitialized.
 */
