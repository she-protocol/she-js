...
import { MsgApplyPendingBalance, MsgCloseAccount, MsgInitializeAccount, MsgTransfer, MsgWithdraw } from "@she-js/cosmos/types/confidentialtransfers";
...
import { getConfidentialTransfersPrecompileEthersV6Contract } from "@she-js/evm";
 ...
 *
 * @param address - The 0x or SHE address of the account holder.
 * @param denom - The denomination (e.g., "ushe").
 ...
 *
 * @param signedDenom - Signature over the hashed denom generated by getDenomToSignEthers.
 * @param address - 0x or she address of the account.
 * @param denom - The denomination (e.g., "ushe").
 ...
 *
 * @param denom - Denomination to deposit into (e.g., "ushe").
 * @param amount - Amount in base units (e.g., 1 SHE = 1_000_000).
 * @param contractRunner - The signer to send the transaction.
 ...
 *
 * @param address - 0x or she address of the account holder.
 ...
 *
 * @param senderAddress - 0x or she address of the sender.
 * @param recipientAddress - 0x or she address of the recipient.
